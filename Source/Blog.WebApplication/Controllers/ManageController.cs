namespace Blog.WebApplication.Controllers
{
    ...
    using Enums;
    using Models.ViewModels.ManageAccountViewModels;

    [Authorize]
    public class ManageController : ManageAccountBaseController
    {
        // GET: /Manage/Index
        ...
        {
            var result = await this.UserManager.SetPhoneNumberAsync(
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            return result.Succeeded ?
                ...
                this.RedirectToAction("ManageLogins", new
                {
                    Message = ManageMessageId.Error
                });
        }
